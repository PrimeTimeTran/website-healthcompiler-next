    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
            <div className="max-w-3xl">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-foreground leading-[1.1]">
                Route Patient Calls With <span className="text-primary">Clarity</span>
              </h1>

              <p className="text-lg text-muted-foreground mb-8">
                AI Call Triaging helps practices handle calls from existing patients by
                understanding the reason for the call and routing it appropriately.
              </p>
              <CTAButton
                link="/contact"
                text="Request a Demo"
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-8">How It Helps</h2>
            ...
            <p className="text-lg text-muted-foreground">
              The result is faster routing, clearer priorities, and a better experience for patients
              and staff.
            </p>
          </div>
        </div>
