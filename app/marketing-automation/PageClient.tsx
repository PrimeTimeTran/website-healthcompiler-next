            ...
            <div className="space-y-8">
              <div>
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-foreground leading-[1.1] mb-6">
                  Turn Inquiries Into <span className="text-primary">Conversations</span>
                </h1>

                <p className="text-lg text-muted-foreground mb-4">
                  Health Compiler automates patient outreach, tracks marketing performance, and
                  connects every inquiry to measurable revenue—without adding operational
                  complexity.
                </p>

                <p className="text-base text-muted-foreground mb-8">
                  From first touch to booked visit to collected revenue, see exactly what's
