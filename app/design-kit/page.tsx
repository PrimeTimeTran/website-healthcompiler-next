  ...
  return (
    <>
      <div className="container mx-auto px-6 py-24 space-y-24">
        <div className="flex items-start justify-between">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl">
              Comprehensive guide to the design tokens, typography, colors, and components used
              across the Healthcare Data Platform.
            </p>
          </div>
          {mounted && (
            <Button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">Outfit Bold 48px</p>
                </div>
                <div>
                  <h2 className="font-display text-4xl font-semibold">Heading 2</h2>
                  <p className="text-xs text-muted-foreground mt-1">Outfit Semibold 36px</p>
                </div>
                <div>
                  <h3 className="font-display text-3xl font-semibold">Heading 3</h3>
                  <p className="text-xs text-muted-foreground mt-1">Outfit Semibold 30px</p>
                </div>
                <div>
                  <h4 className="font-display text-2xl font-semibold">Heading 4</h4>
                  <p className="text-xs text-muted-foreground mt-1">Outfit Semibold 24px</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div>
                  <p className="text-lg">
                    Large body text. Used for lead paragraphs and introductions. The quick brown fox
                    jumps over the lazy dog.
                  </p>
                  <p className="text-xs text-muted-foreground mt-1">Inter Regular 18px</p>
                </div>
                <div>
                  <p className="text-base">
                    Default body text. Used for general content. The quick brown fox jumps over the
                    lazy dog.
                  </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-8">
            <div className="space-y-6">
              ...
              <div className="font-apex-display">
                <h1 className="text-5xl italic font-semibold">Editorial Heading</h1>
            ...
            <div className="space-y-6">
              ...
              <div className="font-apex-body space-y-2">
                <p className="text-lg">Editorial body text for magazine layouts.</p>
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                ...
                />
                <ColorCard name="Success" bg="bg-success" text="text-success-foreground" />
                <ColorCard name="Card" bg="bg-card" text="text-card-foreground" border="border" />
                <ColorCard
                  name="Popover"
                  bg="bg-popover"
            ...
            <div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                <ColorCard name="Apex Bg" bg="bg-apex-bg" text="text-apex-foreground" />
                <ColorCard
                  name="Apex Secondary"
                  bg="bg-apex-bg-secondary"
                  text="text-apex-foreground"
                />
                <ColorCard name="Apex Accent" bg="bg-apex-accent" text="text-apex-bg" />
                <ColorCard name="Apex Warm" bg="bg-apex-accent-warm" text="text-white" />
                <ColorCard name="Apex Muted" bg="bg-apex-muted" text="text-apex-foreground" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <GradientCard name="Hero Gradient" className="bg-(image:--gradient-hero)" />
                <GradientCard name="Accent Gradient" className="bg-(image:--gradient-accent)" />
                <GradientCard name="CTA Gradient" className="bg-(image:--gradient-cta)" />
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="p-8 rounded-lg border border-border bg-card">
                ...
                <p className="text-muted-foreground">
                  Standard card container with border and background color. Used for most content
                  blocks.
                </p>
              </div>

              <div className="p-8 rounded-lg border border-border bg-background-secondary">
                <h4 className="font-semibold text-lg mb-2">Secondary Background</h4>
                <p className="text-muted-foreground">
              ...
              <div className="interactive-card p-8 rounded-lg border border-border bg-card cursor-pointer">
                ...
                <p className="text-muted-foreground">
                  Hover me! This card uses the <code>.interactive-card</code> utility class for
                  hover effects.
                </p>
              </div>
        ...
        <section className="space-y-8">
          <h2 className="text-2xl font-semibold border-b border-border pb-2">Animations</h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className="p-6 rounded-lg border border-border bg-card flex flex-col items-center gap-4 overflow-hidden relative">
              ...
              <span className="text-sm text-muted-foreground relative z-10">Overlay Effect</span>
            </div>
          </div>
