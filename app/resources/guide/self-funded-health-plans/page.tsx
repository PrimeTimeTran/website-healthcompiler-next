...
const SelfFundedHealthPlansGuide = () => {
  ...
  const tpaResponsibilities = [
    {
      ...
      description: 'Accurately and efficiently processing employee healthcare claims.',
    },
    {
    ...
    },
    {
      ...
      description: 'Providing support to plan members and employers with questions or issues.',
    },
    {
    ...
    },
    {
      ...
      description: 'Negotiating with healthcare providers to secure favorable rates.',
    },
  ]
  ...
  const implementationSteps = [
    {
      ...
      description: "Evaluating the employer's specific needs and objectives for a health plan.",
    },
    {
      step: 2,
    ...
    },
    {
      ...
      description: 'Continuously monitoring plan performance and making adjustments as needed.',
    },
  ]
  ...
  const disadvantages = [
    ...
    },
    {
      ...
      description: 'Managing a self-funded plan can be more complex than a fully insured plan.',
    },
    {
    ...
    <>
        ...
        <div className="container mx-auto px-4 md:px-6 relative">
          <div className="max-w-4xl mx-auto text-center fade-in">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-3xl mx-auto">
              Self-funded health plans have become increasingly popular among employers of all
              sizes. In a self-funded plan, the employer assumes the financial risk for employee
              healthcare costs, offering greater control over plan design, cost savings, and
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto">
            <p className="text-muted-foreground mb-8 text-center">
              ...
              framework strongly encourages the use of self-funded health plans, where employers
              assume the financial risk for their employees' healthcare costs.
            </p>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="max-w-4xl">
            <p className="text-lg text-muted-foreground mb-6">
              In a traditional fully insured health plan, the employer pays premiums to an insurance
              carrier, which assumes the financial risk for employee healthcare costs.
            </p>
            <div className="bg-linear-to-br from-primary/5 to-accent/5 rounded-xl p-6 md:p-8 border border-border">
              <p className="text-foreground font-medium">
                In contrast, a self-funded plan shifts this risk to the employer. The employer
                directly pays for employee healthcare claims, while typically using a third-party
                administrator (TPA) to manage the plan's day-to-day operations.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <p className="text-lg text-muted-foreground mb-10 max-w-3xl">
            TPAs play a crucial role in the success of self-funded plans. Their responsibilities
            typically include:
          </p>
      ...
      <section className="py-16 md:py-24 bg-muted/30">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <p className="text-lg text-muted-foreground mb-10 max-w-3xl">
            Stop-loss insurance is a critical component of any self-funded plan. It protects the
            employer from the financial risk of large or unpredictable claims.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-card rounded-xl p-6 shadow-card border-l-4 border-primary">
              ...
              <p className="text-muted-foreground">
                This type of coverage protects the employer from individual claims that exceed a
                certain threshold.
              </p>
            </div>
            <div className="bg-card rounded-xl p-6 shadow-card border-l-4 border-accent">
              ...
              <p className="text-muted-foreground">
                This type of coverage protects the employer from the total cost of claims exceeding
          ...
          <p className="text-muted-foreground bg-card rounded-lg p-4 border border-border">
            The choice of stop-loss coverage will depend on the specific needs and risk tolerance of
            the employer.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-muted/30">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <p className="text-lg text-muted-foreground mb-10 max-w-3xl">
            Implementing a self-funded plan requires careful planning and execution. Key steps
            include:
          </p>
      ...
      <section className="py-16 md:py-24 bg-muted/30">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="max-w-4xl">
            <p className="text-lg text-muted-foreground mb-6">
              A self-insured plan, also known as a self-funded plan, is a health insurance model
              where the employer assumes the financial risk for providing healthcare benefits to
              employees. Instead of paying fixed premiums to an insurance company, the employer
              directly pays for medical claims as they arise.
            </p>
            <div className="bg-card rounded-xl p-6 shadow-card">
              <p className="text-muted-foreground">
                Self-insured plans are often managed with the help of third-party administrators
                (TPAs) who handle tasks like claims processing and provider network management,
                while the employer retains ultimate financial responsibility. This model is
                particularly common among larger companies, which may benefit from economies of
                scale in managing healthcare costs.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <p className="text-lg text-muted-foreground mb-10 max-w-3xl">
            Many employers have successfully implemented self-funded plans and achieved significant
            cost savings. Some best practices include:
          </p>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="bg-card rounded-xl p-6 md:p-8 shadow-card max-w-4xl">
            <p className="text-lg text-muted-foreground">
              Self-funded health plans can be a complex but potentially rewarding option for
              employers seeking to control healthcare costs and improve employee benefits. By
              carefully considering the factors discussed in this guide and working with experienced
              partners, employers can successfully implement and manage a self-funded plan that
              meets their specific needs and objectives.
            </p>
          </div>
        </div>
      </section>
