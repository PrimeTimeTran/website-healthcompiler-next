          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="fade-in">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-4">
                Understanding <span className="text-primary">Direct Specialty Care</span>
              </h1>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="max-w-4xl">
            <p className="text-lg text-muted-foreground mb-6">
              Direct Specialty Care is a model of healthcare delivery that promotes the
              patient-physician relationship and removes third-party payors to protect the best
              interests of patients.
            </p>

            <div className="bg-card rounded-xl p-6 md:p-8 shadow-card">
              <p className="text-muted-foreground">
                Direct Specialty Care is a healthcare model different from your typical
                fee-for-service and insurance billing type of medical practice. Instead, direct
                specialty care operates like a subscription service with an affordable membership
                fee. You join as a member, and, as such, you are entitled to medical services,
                discounted pricing, and many other services (e.g., nutrition, mindfulness, and
                physician therapy classes). It is a direct financial arrangement between the patient
                and the doctor.
              </p>
              <p className="text-foreground font-medium mt-4">
                The result is enhanced patient experience, better health outcomes, and more
          ...
          <div className="space-y-12">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-card rounded-xl p-6 shadow-card card-hover">
                  ...
                  <p className="text-muted-foreground text-sm">
                    In the DSC model, patients can book appointments directly with specialists
                    without needing a referral from a primary care physician. This approach
                    minimizes delays in accessing specialized care, ensuring more timely and
                ...
                <div className="bg-card rounded-xl p-6 shadow-card card-hover">
                  ...
                  <p className="text-muted-foreground text-sm">
                    DSC facilitates more extended and direct interactions between patients and
                    specialists. This increased communication allows specialists to gain a
                    comprehensive understanding of each patient's health history, lifestyle, and
                    concerns.
                  </p>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-card rounded-xl p-6 shadow-card card-hover">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Appointments are significantly longer, often ranging from 30 to 60 minutes or
                    more, compared to the typical 15-minute slots in traditional settings. This
                    extended time allows for thorough discussions, detailed examinations, and more
                ...
                <div className="bg-card rounded-xl p-6 shadow-card card-hover">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Specialists in DSC can develop highly individualized treatment plans that
                    consider not only the medical condition but also the patient's lifestyle,
            ...
            <div>
              ...
              <div className="bg-card rounded-xl p-6 shadow-card">
                ...
                <p className="text-muted-foreground mb-4">
                  DSC practices typically offer a transparent and straightforward pricing structure
                  for all services:
                </p>
            ...
            <div>
              ...
              <div className="bg-linear-to-br from-primary/5 to-accent/5 rounded-xl p-6 border border-border">
                <p className="text-muted-foreground mb-4">
                  Many DSC practices utilize a subscription model where patients pay a recurring
                  fee. This fee often covers:
                </p>
                ...
                <p className="text-foreground font-medium">
                  This model provides financial predictability for patients while ensuring a stable
                  income for specialists.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <p className="text-lg text-muted-foreground mb-10 max-w-3xl">
            Traditional healthcare models often entail lengthy wait times, limited appointment
            durations, and intricate billing processes. DSC addresses these challenges by offering:
          </p>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="bg-card rounded-xl p-6 md:p-8 shadow-card max-w-4xl">
            <p className="text-lg text-muted-foreground">
              Direct Specialty Care revolutionizes healthcare by fostering a direct financial
              relationship between patients and physicians, bypassing third-party payors. This model
              ensures patients receive personalized, high-quality care with enhanced access to
              medical services and holistic health benefits. By focusing on the patient-physician
              relationship and offering an affordable membership, Direct Specialty Care delivers{' '}
              <strong className="text-foreground">
                better health outcomes, reduced medical costs, and an improved patient experience
              </strong>
              .
            </p>
          </div>
