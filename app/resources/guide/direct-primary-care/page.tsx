    ...
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="fade-in">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-foreground mb-4">
                <span className="text-primary">Direct Primary Care</span> Practice Model
              </h1>
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-xl">
                Reimagined Healthcare Delivery Through Accessible, Personalized, and Transparent
                Services
              </p>
              <Link href="/contact">
                <Button
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">
            Key points: What is <span className="text-primary">Direct Primary Care Model</span>
          </h2>
          <p className="text-lg text-muted-foreground mb-10 max-w-3xl">
            Direct Primary Care is a healthcare model where patients pay a monthly or annual fee
            directly to their primary care physician, eliminating insurance for routine care:
          </p>
          ...
          <p className="text-lg text-muted-foreground mt-8 max-w-3xl">
            DPC seeks to improve healthcare accessibility, enhance the doctor-patient relationship,
            and offer more transparent pricing for primary care services.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-muted/30">
        <div className="container mx-auto px-4 md:px-6">
          <p className="text-lg text-muted-foreground mb-10 max-w-4xl">
            As health insurance becomes increasingly confusing and expensive, new care models have
            emerged. One option people are considering is direct primary care (DPC) to access and
            afford basic medical services.
          </p>
          ...
          <p className="text-lg text-muted-foreground mb-6 max-w-4xl">
            Direct primary care (DPC) is a financial arrangement directly between you and your
            healthcare provider, bypassing insurance companies and eliminating the need to file
            insurance claims.
          </p>
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4 md:px-6">
            ...
            {[
              {
                ...
                description: 'Internal medicine physicians, or internists, who treat adults.',
              },
              {
                icon: Users,
              ...
              },
              {
                icon: Heart,
                title: 'Pediatrics',
                description: 'Pediatricians who treat babies, children, and adolescents.',
              },
            ].map((item, index) => (
              <div
                key={index}
          ...
          <p className="text-muted-foreground mb-6">
            Depending on your location, DPC practices may include the following healthcare providers
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-10">
            <div className="bg-card rounded-lg p-5 shadow-soft">
              ...
              <p className="text-muted-foreground text-sm">
                Also known as physician assistants, they may use either title depending on the
                jurisdiction.
              </p>
            </div>
            <div className="bg-card rounded-lg p-5 shadow-soft">
          ...
          <div className="bg-muted/50 rounded-xl p-6 border border-border">
            <p className="text-muted-foreground">
              <strong className="text-foreground">Note:</strong> There is a distinction between DPC
              and concierge medicine, which provides premium services typically catering to
              higher-income individuals. Both models offer extended visits with physicians, but
              concierge medicine practices usually charge higher monthly fees and also accept
              insurance.
            </p>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-muted/30">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <p className="text-lg text-muted-foreground mb-10 max-w-3xl">
            There are many advantages to using DPC. Here are some direct primary care benefits of
            entering into a financial agreement with a healthcare professional:
          </p>
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            <div>
              <p className="text-lg text-muted-foreground mb-6">
                ...
                <strong className="text-foreground">$100</strong>, and it may be even less. This fee
                provides you with unlimited and direct access to your primary care provider (PCP).
              </p>
              <p className="text-muted-foreground mb-6">
                In general, fees are based on factors such as your age, the type of practice, and
          ...
          <p className="text-muted-foreground mt-8 p-4 bg-muted/50 rounded-lg border border-border">
            <strong className="text-foreground">Note:</strong> The monthly fee does not include
            visits to specialists, urgent care, or hospital services. Medications, whether
            prescription or over the counter, are also not part of a DPC financial agreement.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <p className="text-lg text-muted-foreground mb-6">
            People using DPC often value the ability to contact their provider at any time, making
            it particularly appealing to:
          </p>
          ...
          <div className="bg-gradient-to-r from-primary/5 to-accent/5 rounded-xl p-6 md:p-8 border border-border">
            ...
            <p className="text-foreground font-medium">
              DPC is typically most beneficial for individuals who are generally healthy or seek
              enhanced access to a primary care provider for routine visits or short-term health
              concerns.
            </p>
          </div>
        </div>
      ...
      <section className="py-16 md:py-24 bg-muted/30">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <p className="text-muted-foreground mb-6 max-w-4xl">
            ...
            , user-friendly interfaces and strong data security features are crucial components.
          </p>

          <div className="bg-card rounded-xl p-6 md:p-8 shadow-card">
            <p className="text-foreground font-medium">
              Health Compiler stands out as the perfect EHR system for Direct Primary Care, offering
              a customizable platform that boosts clinical efficiency and productivity to support
      ...
      <section className="py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <p className="text-lg text-muted-foreground mb-10 max-w-3xl">
            Direct primary care differs from concierge care by featuring lower monthly fees, opting
            out of participation in payer programs, and applying patient membership fees to a wider
            array of services.
          </p>
      ...
      <section className="py-16 md:py-24 bg-muted/30">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-3xl">
            If your current primary care provider is open to it, ask if they are willing to enter
            into a DPC agreement. Two helpful resources for locating a DPC practice in your area:
          </p>
