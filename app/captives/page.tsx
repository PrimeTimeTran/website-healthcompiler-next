          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-muted-foreground">
                Intelligence and analytics for self-funded captives and union health plans—bringing
                clarity, control, and defensible insight to pooled risk.
              </p>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Health Compiler supports stop-loss optimization by providing visibility into large
              claims, risk distribution, and deductible exposure across pooled populations.
            </p>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-6">
          <div className="max-w-3xl mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Health Compiler enhances broker and advisor relationships by providing a shared
              intelligence layer that supports better strategy, clearer storytelling, and stronger
              client outcomes.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-8">
                Every report is designed to support fiduciary responsibility, long-term
                sustainability, and confident decision-making.
              </p>
            ...
            <div className="bg-card border border-border rounded-2xl p-8">
              <div className="space-y-6">
                ...
                {['Pool Performance', 'Cohort Analysis', 'Stop-Loss Exposure', 'Trend Report'].map(
                  (report, idx) => (
