          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Health Compiler supports Direct Primary Care practices with AI-powered data and
                growth solutions that make day-to-day operations simpler and long-term value easier
                to show.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Direct Primary Care generates meaningful data every day. The challenge is turning that
              data into something useful. Health Compiler brings it together so practices can:
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Direct Primary Care depends on sustained engagement and clear value demonstration.
                Health Compiler provides the data foundation for both.
              </p>
