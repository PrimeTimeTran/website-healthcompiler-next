          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
            <div className="space-y-8">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-foreground leading-[1.1]">
                Clear, Actionable <span className="text-primary">Data Insights</span>
              </h1>

              <p className="text-xl text-muted-foreground mb-8">
                Helping DPC networks save time, reduce guesswork, and prove value across all their
                practices.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Network leaders need visibility without micromanagement. Health Compiler brings
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Health Compiler supports growth without forcing standardization or creating extra
                work for clinics.
              </p>
