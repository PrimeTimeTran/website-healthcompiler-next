...
import { Zap, Heart, Users, Brain, Shield, Activity, TrendingUp, Building2 } from 'lucide-react'
    ...
    <>
        ...
        <div className="container mx-auto px-6 relative">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed">
              The AI engine purpose-built for healthcare — powering intelligent automation,
              predictive analytics, and personalized experiences for self-funded employers, direct
              care practices, and value-based organizations.
            </p>
        ...
        <div className="container mx-auto px-6 relative">
          <div className="text-center mb-14">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Infera adapts to your specific needs — whether you're managing employer plans, running
              a direct care practice, or optimizing value-based contracts.
            </p>
          </div>
      ...
      <section className="relative py-20 md:py-28 bg-white overflow-hidden">
        <div className="container mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Built specifically for healthcare, Infera delivers intelligence that generic AI
      ...
      <section className="relative py-20 bg-linear-to-br from-primary/5 via-white to-accent/5 overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center relative">
          <h2 className="font-display text-3xl md:text-4xl font-bold text-foreground mb-4">
            Ready to <span className="text-primary">activate your healthcare data</span>?
          </h2>
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto mb-8">
            See how Infera can transform your organization — whether you're a self-funded employer,
            direct care practice, or value-based organization.
          </p>
          <Button size="lg" asChild>
