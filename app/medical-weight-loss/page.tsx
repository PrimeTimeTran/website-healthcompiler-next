          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Clear data helps teams understand what is working, where patients disengage, and
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Track adherence and outcomes across the patient journey. Bringing that information
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            <div>
              ...
              <p className="text-lg text-foreground font-medium">
                Clear insight helps teams stay aligned, patients stay supported, and outcomes stay
                visible.
              </p>
            </div>
