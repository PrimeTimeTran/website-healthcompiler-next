            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Whether you're looking to modernize your healthcare data infrastructure, build
                  custom analytics solutions, or automate operational workflows—we're here to help.
                </p>
              </div>
