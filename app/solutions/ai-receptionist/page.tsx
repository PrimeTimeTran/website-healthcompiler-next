    ...
    <div className="relative w-full h-[400px] flex items-center justify-center">
      <svg viewBox="0 0 500 350" className="w-full h-full max-w-lg">
        ...
        <g>
          ...
          <text x="250" y="185" textAnchor="middle" className="fill-white text-[10px]">
            Receptionist
          </text>
        </g>
        ...
        {outcomes.map((outcome, i) => {
          ...
          return (
            <g key={outcome.label}>
              ...
              />
              <text x="442" y={y + 4} textAnchor="middle" className="fill-foreground text-[10px]">
                {outcome.label}
              </text>
            </g>
          )
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
            <div className="space-y-8">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-foreground leading-[1.1]">
                AI Receptionist for <span className="text-primary">Modern Healthcare</span>
              </h1>
