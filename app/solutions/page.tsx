...
import { Users, Receipt, Activity, ArrowRight, TrendingUp, LayoutDashboard } from 'lucide-react'
      ...
      <section className="section-padding bg-linear-to-b from-background to-background-secondary">
        <div className="container-tight mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Real-world applications of our healthcare data platform, designed to solve your most
      ...
      <section className="section-padding bg-background-secondary">
        <div className="container-tight mx-auto text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
            We build custom solutions for unique healthcare data challenges. Let's explore what's
            possible.
          </p>
