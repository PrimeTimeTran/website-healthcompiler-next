          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
            <div className="space-y-8">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Helping Managed Service Organizations bring clarity, consistency, and confidence
                with AI powered data solutions.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              MSOs need visibility without micromanagement. Health Compiler brings together the data
              that helps you:
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                Strong MSOs are measured by how well they support consistency, quality, and growth
                across practices. Health Compiler helps MSOs stay ahead.
              </p>
      ...
      <section className="py-20 bg-linear-to-br from-primary/5 via-background to-primary/5">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              If you support multiple practices and want better visibility without added operational
              burden, let's talk.
            </p>
            <CTAButton link="/contact" text="Request a Demo" suffixIconDefault />
          </div>
