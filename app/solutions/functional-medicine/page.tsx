...
import { Bot, Brain, Workflow, ArrowRight, TrendingUp, CheckCircle } from 'lucide-react'
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
            <div className="space-y-8">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-foreground leading-[1.1]">
                Clarity for Personalized <span className="text-primary">Root-Cause Care</span>
              </h1>

              <p className="text-xl text-muted-foreground mb-8">
                Track engagement, follow-through, and outcomes across long-term care plans. Layered
                patient data becomes easier to understand, compare, and act on over time.
              </p>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground mb-8">Health Compiler helps practices:</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-4">
              Health Compiler integrates with the tools functional medicine teams already rely on.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Health Compiler helps functional medicine practices connect data, care, and outcomes,
