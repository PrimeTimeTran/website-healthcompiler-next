        ...
        <div className='container mx-auto px-4'>
          <div className='max-w-4xl mx-auto'>
            ...
            <p className='text-lg text-muted-foreground mb-8'>
              Concierge practices thrive on personal relationships. Health
              Compiler helps you maintain that high-touch care while gaining
              clarity on:
            </p>
          ...
          <div className='grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto'>
            <div>
              ...
              <p className='text-lg text-muted-foreground mb-6'>
                Technology that supports, never replaces, the high-touch
                relationship that defines concierge care.
              </p>
              <div className='space-y-3'>
                <div className='flex items-center gap-3'>
                  <CheckCircle className='h-5 w-5 text-primary flex-shrink-0' />
                  <span className='text-foreground'>
                    Preserves personal care relationships
                  </span>
                </div>
                <div className='flex items-center gap-3'>
                  <CheckCircle className='h-5 w-5 text-primary flex-shrink-0' />
