          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
            <div className="space-y-8">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-foreground leading-[1.1]">
                <span className="text-primary">Clarity</span> for Busy Pediatric Practices
              </h1>

              <p className="text-xl text-muted-foreground mb-8">
                See how families engage with your practice, where follow-ups are falling behind, and
                which preventive needs need attention.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-4">
              Health Compiler integrates with the tools pediatric practices already use.
            </p>
      ...
      <section className="py-20 bg-linear-to-br from-primary/5 via-background to-primary/5">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Health Compiler works quietly in the background, helping pediatric teams stay
              organized, responsive, and confident as they grow.
            </p>
            <CTAButton link="/contact" text="Book a Demo" suffixIconDefault />
          </div>
        </div>
