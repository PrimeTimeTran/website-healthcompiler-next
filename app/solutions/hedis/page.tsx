        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <div className="space-y-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-foreground leading-[1.1]">
              Quality Measures, <span className="text-primary">Continuously Improved</span>
            </h1>

            <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-xl">
              Track, close, and improve HEDIS and quality gaps in real time—without chasing reports
              or year-end fire drills.
            </p>
                  ...
                  {measures.map((measure, idx) => {
                    ...
                    return (
                      <div
                        ...
                        style={{
                          animation:
                            measure.status === 2 ? 'pulse 2s ease-in-out infinite' : 'none',
                        }}
                      >
  ...
  const tiles = [
    {
      ...
      detail: 'Mammograms, colonoscopies, and wellness visits tracked and scheduled automatically',
    },
    {
      icon: Activity,
      title: 'Chronic Condition Mgmt',
      detail: 'Diabetes, hypertension, and heart disease measures with proactive intervention',
    },
    {
      icon: Pill,
      title: 'Medication Adherence',
      detail: 'Refill gaps detected and patient nudges triggered before issues arise',
    },
    {
      icon: Calendar,
      title: 'Care Follow-ups',
      detail: 'Post-discharge and specialist follow-up tracking with automated reminders',
    },
    {
      icon: Users,
      title: 'Population Health',
      detail: 'Aggregate quality metrics across patient populations and risk segments',
    },
    {
      icon: Settings,
      title: 'Custom Programs',
      detail: 'Configure custom measures for employer wellness or payer-specific requirements',
    },
  ]
