        ...
        <div className='grid lg:grid-cols-2 gap-16 lg:gap-20 items-center'>
          <div className='space-y-8'>
            ...
            <p className='text-lg md:text-xl text-muted-foreground leading-relaxed max-w-xl'>
              Health Compiler unifies clinical, claims, and quality data into a
              single intelligence layer—powering performance, reporting, and
              outcomes across accountable care organizations and registry
              programs.
            </p>
      ...
      <div className='container mx-auto px-6'>
        <div className='max-w-4xl'>
          ...
          <p className='text-lg text-muted-foreground mb-8'>
            Health Compiler provides ACO analytics designed to support ACO
            value-based care programs by bringing clinical and operational data
    ...
    <section className='py-24 bg-linear-to-b from-slate-50 to-white'>
      <div className='container mx-auto px-6'>
        <div className='max-w-4xl'>
          ...
          <p className='text-lg text-muted-foreground mb-8'>
            Health Compiler helps answer a common question: how can ACO
            analytics improve care coordination in real-world settings?
          </p>
          <div className='space-y-4 mb-8'>
          ...
          <p className='text-muted-foreground mb-8'>
            This approach strengthens population health management for ACOs by
            making performance visible across the network.
          </p>
          <Button
            size='lg'
            variant='outline'
    ...
    <section className='py-24 bg-white'>
      <div className='container mx-auto px-6'>
        <div className='max-w-4xl'>
          ...
          <p className='text-muted-foreground mb-8'>
            Built to scale with growing ACO networks and evolving program
            requirements.
          </p>
          <CTAButton
            link='/contact'
      ...
      <div className='container mx-auto px-6'>
        <div className='max-w-3xl mx-auto text-center mb-16'>
          ...
          <p className='text-lg text-muted-foreground'>
            ACOs operate at the intersection of quality, cost, and coordination.
            Health Compiler provides the data foundation and intelligence needed
            to track performance, surface risk, and deliver defensible results
            across MSSP, REACH, and commercial ACO models.
          </p>
        </div>
    ...
    <section className='py-24 bg-linear-to-b from-slate-50 to-white'>
      <div className='container mx-auto px-6'>
        <div className='max-w-3xl mx-auto text-center mb-16'>
          ...
          <p className='text-lg text-muted-foreground'>
            Registries play a critical role in measuring outcomes, tracking
            disease burden, and supporting value-based programs. Health Compiler
            enables registries to aggregate, normalize, and analyze data across
            sources—without building custom infrastructure.
          </p>
        </div>
        ...
        <div className='max-w-5xl mx-auto'>
          <div className='text-center mb-16'>
            ...
            <p className='text-lg text-muted-foreground max-w-2xl mx-auto'>
              Whether supporting accountable care performance or
              population-level registries, Health Compiler acts as the neutral
              data activation layer—connecting fragmented systems into
                ...
                <div className='bg-white rounded-xl p-4 border border-border/50'>
                  ...
                  <div className='flex gap-1'>
                    {[...Array(12)].map((_, i) => (
                      <div
                        key={i}
                        className='h-2 flex-1 bg-accent/60 rounded-full'
                      />
                    ))}
                  </div>
                </div>
        ...
        <div className='max-w-4xl mx-auto'>
          <div className='text-center mb-16'>
            ...
            <p className='text-lg text-muted-foreground'>
              ...
              highlight meaningful changes, and surface risks and gaps—helping
              both ACO operators and registry teams focus on action, not data
              wrangling.
            </p>
          </div>
      ...
      <div className='container mx-auto px-6'>
        <div className='max-w-4xl mx-auto'>
          <div className='text-center mb-16'>
            ...
            <p className='text-lg text-muted-foreground'>
              Generate clean, defensible reports aligned to CMS, payer, and
              public health requirements—built to support audits, reviews, and
    ...
    <section className='py-24 bg-primary text-primary-foreground'>
      <div className='container mx-auto px-6 text-center'>
        ...
        <p className='text-lg opacity-90 mb-8 max-w-2xl mx-auto'>
          Unify clinical, claims, and quality data into decision-grade
          intelligence for ACOs and registries.
        </p>
        <CTAButton
          link='/contact'
