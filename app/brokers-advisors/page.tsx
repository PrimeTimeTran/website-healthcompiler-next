          ...
          <div className='grid lg:grid-cols-2 gap-16 lg:gap-20 items-center'>
            <div className='space-y-8'>
              <h1 className='text-4xl md:text-5xl lg:text-6xl font-display font-bold text-foreground leading-[1.1]'>
                ...
                <span className='text-primary'>Benefits Advisors</span>
              </h1>

              <p className='text-xl text-muted-foreground mb-8'>
                Help your clients understand plan performance, demonstrate ROI,
                and make informed decisions with clear analytics.
              </p>
        ...
        <div className='container mx-auto px-4'>
          <div className='max-w-4xl mx-auto'>
            ...
            <p className='text-lg text-muted-foreground mb-8'>
              Benefits advisors need more than intuition to guide clients.
              Health Compiler brings together the data that helps you:
            </p>
        ...
        <div className='container mx-auto px-4'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-lg text-muted-foreground mb-4'>
              Health Compiler integrates with the tools advisors and their
              clients already use.
            </p>
          ...
          <div className='grid md:grid-cols-2 gap-12 items-center max-w-5xl mx-auto'>
            <div>
              ...
              <p className='text-lg text-muted-foreground mb-6'>
                Benefits advisors succeed when they can demonstrate clear value
                to clients. Health Compiler provides the data foundation for
