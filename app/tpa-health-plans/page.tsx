            ...
            <div className="space-y-8">
              <div className="max-w-3xl">
                <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-foreground leading-[1.1]">
                  Measure How <span className="text-primary">Care Strategies</span> Perform — Across
                  Models
                </h1>

                <p className="text-xl text-muted-foreground mb-8">
                  Understand what's working, where risk is emerging, and how different care
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Health Compiler gives employers and sponsors a consistent, comparable view of
              performance across populations, contracts, and care models — not just at renewal time.
            </p>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Built to integrate cleanly into existing environments without adding operational
              overhead.
            </p>
      ...
      <section className="py-20 bg-primary/5">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
            Move from episodic reporting to continuous insight that supports confident decisions and
            sponsor trust.
          </p>
          <CTAButton text="Request a Demo" link="/contact" />
        </div>
      </section>
    </>
  )
