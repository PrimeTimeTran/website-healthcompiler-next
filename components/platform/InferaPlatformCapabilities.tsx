...
export const InferaPlatformCapabilities = () => {
  return (
    <div className='relative'>
      ...
      <section className='relative py-24 md:py-32 bg-linear-to-b from-white to-slate-50/50 overflow-hidden'>
        <div className='container mx-auto px-6'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-lg md:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto'>
              A unified data and analytics platform that connects care delivery,
              employer outcomes, and value-based performance — without forcing
              stakeholders into rigid workflows.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className='container mx-auto px-6'>
          <div className='flex flex-col items-center'>
            ...
            <div className='relative mb-16'>
              {/* Outer glow ring */}
              <div className='absolute inset-0 w-48 h-48 md:w-64 md:h-64 rounded-full bg-linear-to-br from-primary/10 via-accent/10 to-primary/5 blur-2xl animate-pulse' />

              {/* Gradient ring */}
              <div className='relative w-48 h-48 md:w-64 md:h-64 rounded-full bg-linear-to-br from-primary/20 via-accent/15 to-primary/10 p-1'>
              ...
              <div
                className='absolute inset-0 w-48 h-48 md:w-64 md:h-64 rounded-full border border-primary/10 animate-ping'
                style={{ animationDuration: '3s' }}
              />
              <div
                className='absolute inset-0 w-48 h-48 md:w-64 md:h-64 rounded-full border border-accent/10 animate-ping'
                style={{ animationDuration: '4s', animationDelay: '1s' }}
              />
            </div>

            <p className='text-sm text-muted-foreground text-center max-w-md'>
              Unified data, analytics, and automation across healthcare
              ecosystems
            </p>
          </div>
        </div>
        ...
        <div className='container mx-auto px-6 relative'>
          <div className='text-center mb-14'>
            ...
            <p className='text-muted-foreground text-lg max-w-2xl mx-auto'>
              Everything you need to transform healthcare data into actionable
              intelligence.
            </p>
          </div>
      ...
      <section className='relative py-20 md:py-28 bg-linear-to-b from-slate-50 to-white overflow-hidden'>
        <div className='container mx-auto px-6'>
          <div className='text-center mb-14'>
            ...
            <p className='text-muted-foreground text-lg max-w-2xl mx-auto'>
              Infera doesn't just surface insights. It activates them across
              patient, provider, and employer workflows.
            </p>
          </div>
      ...
      <section className='relative py-20 md:py-28 bg-linear-to-br from-primary/5 via-white to-accent/5 overflow-hidden'>
        <div className='container mx-auto px-6 text-center'>
          <h3 className='font-display text-3xl md:text-4xl font-bold text-foreground mb-4'>
            One platform. Many use cases.
          </h3>
          <p className='text-lg text-muted-foreground max-w-2xl mx-auto'>
            Infera adapts to how healthcare actually operates — across
            employers, care teams, and value-based programs.
          </p>
        </div>
      </section>
