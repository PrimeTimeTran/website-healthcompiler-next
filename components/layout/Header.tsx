...
import { X, Plug, Menu, Brain, Users, ChevronDown, ChevronRight, LucideIcon } from 'lucide-react'
      ...
      <div className="container mx-auto px-6 py-4">
        <nav className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-10">
            ...
            >
              <Link
                ...
                className={`flex items-center gap-1.5 text-[15px] font-medium transition-colors hover:text-foreground py-2 ${
                  pathname.startsWith('/platform') ? 'text-foreground' : 'text-muted-foreground'
                }`}
              >
                Platform
                <ChevronDown
            ...
            >
              <Link
                href="#"
                className={`flex items-center gap-1.5 text-[15px] font-medium transition-colors hover:text-foreground py-2 ${
                  pathname === '/solutions' ? 'text-foreground' : 'text-muted-foreground'
                }`}
              >
                Solutions
                <ChevronDown
            ...
            >
              <Link
                href="#"
                className={`flex items-center gap-1.5 text-[15px] font-medium transition-colors hover:text-foreground py-2 ${
                  pathname === '/who-we-serve' ? 'text-foreground' : 'text-muted-foreground'
                }`}
              >
                Who We Serve
                <ChevronDown
            ...
            <Link
              ...
              className={`text-[15px] font-medium transition-colors hover:text-foreground py-2 ${
                pathname === '/resources/apex' ? 'text-foreground' : 'text-muted-foreground'
              }`}
            >
              APEX
            </Link>
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <Button size="lg" className="rounded-full px-5" asChild>
              <Link href="/contact">
                Request a Demo
          ...
          <div className="lg:hidden mt-4 pb-4 border-t border-border/50 pt-4 animate-fade-in">
            <div className="flex flex-col gap-2">
              <div>
                <button
                  onClick={() =>
                    setOpenMobileDropdown(openMobileDropdown === 'Platform' ? null : 'Platform')
                  }
              ...
              <div>
                <button
                  onClick={() =>
                    setOpenMobileDropdown(openMobileDropdown === 'Solutions' ? null : 'Solutions')
                  }
                  className="flex items-center justify-between w-full py-2 text-base font-medium text-muted-foreground"
                >
                  Solutions
                ...
                <button
                  onClick={() =>
                    setOpenMobileDropdown(
                      openMobileDropdown === 'Who We Serve' ? null : 'Who We Serve'
                    )
                  }
                  className="flex items-center justify-between w-full py-2 text-base font-medium text-muted-foreground"
                >
