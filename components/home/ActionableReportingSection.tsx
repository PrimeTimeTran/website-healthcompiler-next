      ...
      <div className='container mx-auto px-6'>
        <div className='grid lg:grid-cols-2 gap-12 lg:gap-20 items-center'>
          ...
          <div className='relative h-[400px] lg:h-[500px] order-2 lg:order-1'>
            ...
            <div className='absolute inset-4 bg-card rounded-2xl shadow-elevated border border-border p-6'>
                ...
                {reportMetrics.map((metric) => (
                  ...
                  >
                    ...
                    <div className='flex items-end gap-2'>
                      ...
                      <span
                        className={`text-xs font-medium ${metric.positive ? 'text-accent' : 'text-destructive'}`}
                      >
                        {metric.trend}
                      </span>
                    </div>
              ...
              <div className='bg-muted/30 rounded-xl p-4 h-24'>
                <div className='flex items-end justify-between h-full gap-2'>
                  {[40, 55, 45, 70, 60, 80, 75, 85, 70, 90, 82, 95].map(
                    (height, i) => (
                      <div
                        key={i}
            ...
            <div
              className='absolute bottom-4 left-0 flex items-center gap-2 bg-card rounded-full px-3 py-1.5 shadow-lg border border-border animate-fade-in'
          ...
          <div className='space-y-6 order-1 lg:order-2'>
            ...
            <p className='text-lg text-muted-foreground leading-relaxed max-w-xl'>
              Clean, defensible reporting that translates complex healthcare
              activity into clarity. Employer-ready, audit-safe, and
              outcome-focused—so performance can be measured, explained, and
              improved.
            </p>
          </div>
        </div>
