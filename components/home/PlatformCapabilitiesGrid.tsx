...
const capabilities = [
  {
    ...
    description:
      'Aggregate insights across your entire patient population with automated risk stratification.',
  },
  {
    icon: BarChart3,
    title: 'Operational & Engagement Analytics',
    description:
      'Real-time visibility into practice operations, patient engagement, and resource utilization.',
  },
  {
    icon: FileText,
    title: 'Employer & Plan-Ready Reporting',
    description:
      'Defensible, audit-safe reports designed for employer clients and health plan stakeholders.',
  },
  {
    icon: Zap,
    title: 'AI-Driven Automation Hooks',
    description:
      'Trigger workflows, alerts, and actions automatically based on clinical and operational signals.',
  },
]
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          {capabilities.map((capability, index) => {
            ...
            return (
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-linear-to-br from-primary/20 to-accent/20 flex items-center justify-center mb-5 group-hover:scale-110 transition-transform duration-300">
