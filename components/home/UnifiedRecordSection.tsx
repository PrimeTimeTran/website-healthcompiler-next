import { Pill, Database, FileText, Activity, FlaskConical, MessageSquare } from 'lucide-react'
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed max-w-xl">
              One longitudinal, normalized record for every member—spanning clinical notes, labs,
              pharmacy, devices, claims, and engagement. Built to support analytics, reporting,
              automation, and real-world decision-making.
            </p>
          </div>
          ...
          <div className="relative h-[400px] lg:h-[500px]">
            ...
            >
              ...
              {/* Flowing dots */}
              {[0, 1, 2, 3, 4].map((i) => (
                <circle key={`dot-${i}`} r="4" fill="hsl(var(--accent))" opacity={0.8}>
                  <animateMotion
                    dur={`${2 + i * 0.3}s`}
