        ...
        <div className='grid lg:grid-cols-2 gap-12 lg:gap-20 items-center'>
          ...
          <div className='space-y-6'>
            ...
            <p className='text-lg text-muted-foreground leading-relaxed max-w-xl'>
              One longitudinal, normalized record for every member—spanning
              clinical notes, labs, pharmacy, devices, claims, and engagement.
              Built to support analytics, reporting, automation, and real-world
              decision-making.
            </p>
          </div>
