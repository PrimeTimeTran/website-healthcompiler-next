...
export function OutcomesMeasureCards() {
  return (
    <div className="mt-16">
      <h3 className="text-2xl font-bold text-center mb-8">What You Can Measure</h3>
      ...
      <p className="text-center text-sm text-muted-foreground mt-8">
        Outcomes can be viewed by member, clinic, cohort, employer group, plan design, and time
        window.
      </p>
    </div>
  )
