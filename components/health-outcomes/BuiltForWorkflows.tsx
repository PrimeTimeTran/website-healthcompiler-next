      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Clear, actionable insights without added operational burden. Health outcomes
            intelligence designed to fit seamlessly into daily clinical and care management
            workflows.
          </p>
        </div>
            ...
            <div className="relative">
              ...
              <svg viewBox="0 0 200 200" className="w-64 h-64 md:w-80 md:h-80 relative z-10">
                ...
                <circle
                  ...
                  strokeWidth="2"
                />
                <text x="100" y="106" textAnchor="middle" fill="hsl(var(--primary))" fontSize="20">
                  ⚡
                </text>
              </svg>
