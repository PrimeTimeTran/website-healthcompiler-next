...
export function OutcomesAnalyticsViews() {
  return (
    <div className="mt-20">
      <h3 className="text-2xl font-bold text-center mb-4">Outcomes Analytics Views</h3>
      <p className="text-muted-foreground text-center mb-10 max-w-2xl mx-auto">
        Actionable dashboards for population health outcomes dashboards and outcomes reporting for
        employers.
      </p>
