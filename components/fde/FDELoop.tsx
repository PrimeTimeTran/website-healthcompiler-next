...
const steps = [
  {
    ...
    title: 'Discover',
    description:
      'Audit your data landscape and map critical workflows to identify high-impact opportunities.',
    icon: Search,
  },
  {
    id: 'integrate',
    title: 'Integrate',
    description:
      'Connect disparate systems into a unified data layer with clean, reliable pipelines.',
    icon: Link,
  },
  {
    id: 'activate',
  ...
  },
  {
    ...
    description:
      'Embed solutions into daily workflows with training, monitoring, and continuous optimization.',
    icon: Cog,
  },
]
                    ...
                    <span
                      className={`absolute whitespace-nowrap text-xs font-medium transition-all duration-300 ${
                        index === 0
                          ...
                          : index === 1
                            ? 'top-1/2 -translate-y-1/2 left-[calc(100%+8px)]'
                            : index === 2
