...
const deployments = [
  {
    ...
    summary:
      'Real-time visibility into healthcare spend and utilization patterns.',
    details: {
  ...
  },
  {
    ...
    summary:
      'End-to-end member journey orchestration from enrollment to engagement.',
    details: {
      ...
      <div className='container mx-auto px-6 lg:px-12'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='text-lg text-muted-foreground max-w-2xl mx-auto'>
            Real solutions we've shipped for healthcare organizations like
            yours.
          </p>
        </div>
          ...
          {deployments.map((deployment, index) => {
            ...
            return (
              ...
              >
                <div className='p-6'>
                  ...
                  <div
                    className={`overflow-hidden transition-all duration-500 ${
                      isExpanded
                        ? 'max-h-40 mt-5 pt-5 border-t border-border/50'
                        : 'max-h-0'
                    }`}
                  >
                ...
                {/* Hover gradient */}
                <div className='absolute inset-0 bg-linear-to-br from-accent/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none' />
              </div>
            )
          })}
        </div>
