      ...
      <>
        <div className='min-h-screen bg-apex-bg flex items-center justify-center'>
          <div className='text-center'>
            <h1 className='text-3xl font-bold text-apex-foreground mb-4'>
              Profile Not Found
            </h1>
          ...
          <div className='container mx-auto px-6'>
            ...
            <div className='grid md:grid-cols-2 gap-12 items-center'>
              ...
              <div>
                ...
                />
                <h2 className='text-apex-accent font-medium text-lg mb-2'>
                  {profile.name}
                </h2>
                {profile.subtitle && (
                  <p className='text-apex-foreground/70 text-xl mb-4'>
                    {profile.subtitle}
                  </p>
                )}
