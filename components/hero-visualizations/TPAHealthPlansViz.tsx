          ...
          >
            ...
            >
              ...
              <div className="flex items-center gap-1">
                <TrendingUp
                  className={`w-3 h-3 ${metric.trend.startsWith('+') ? 'text-green-500' : metric.trend.startsWith('-') ? 'text-red-500' : 'text-blue-500'}`}
                />
                <span
                  className={`text-xs font-semibold ${metric.trend.startsWith('+') ? 'text-green-600' : metric.trend.startsWith('-') ? 'text-red-600' : 'text-blue-600'}`}
                >
                  {metric.trend}
                </span>
              </div>
