...
import { Star, Zap, Mail, Share2, ThumbsUp, Smartphone, MessageSquare } from 'lucide-react'
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          <div className="space-y-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-foreground leading-[1.1]">
              Surveys That Turn Feedback Into <span className="text-primary">Action</span>
            </h1>

            <h2 className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-xl">
              Automatically collect NPS, CSAT, and Google reviews—integrated into your workflows and
