...
const customizations = [
  {
    icon: GitBranch,
    label: 'Survey triggers',
    description: 'When surveys are sent',
  },
  { icon: Route, label: 'Logic & routing', description: 'How responses flow' },
  {
    icon: FileBarChart,
    label: 'Reporting',
    description: 'How insights surface',
  },
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Every organization works differently. Through Forward Deployment Engineering, we
              tailor survey triggers, logic, routing, and reporting to match your real
              workflows—without forcing rigid templates or one-size-fits-all forms.
            </p>
          </div>
          ...
          <div className="text-center">
            <p className="text-lg text-muted-foreground">This isn't just survey software.</p>
