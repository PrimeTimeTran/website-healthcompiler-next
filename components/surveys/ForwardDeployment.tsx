        ...
        <div className='max-w-5xl mx-auto'>
          <div className='text-center mb-12'>
            ...
            <p className='text-lg text-muted-foreground max-w-3xl mx-auto'>
              Every organization works differently. Through Forward Deployment
              Engineering, we tailor survey triggers, logic, routing, and
              reporting to match your real workflows—without forcing rigid
              templates or one-size-fits-all forms.
            </p>
          </div>
