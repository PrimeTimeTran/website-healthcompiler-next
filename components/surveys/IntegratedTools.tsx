        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative order-2 lg:order-1">
              <div className="relative bg-linear-to-br from-card to-muted/30 rounded-2xl p-8 border shadow-xl">
                {/* Central hub */}
            ...
            <div className="space-y-6 order-1 lg:order-2">
              ...
              <p className="text-lg text-muted-foreground">Feedback shouldn't live in a silo.</p>

              <p className="text-muted-foreground">
                Health Compiler integrates survey responses directly into your analytics, CRM,
                communication, and operational systems—so teams can follow up, respond, and improve
                in real time.
              </p>
              ...
              <div className="flex flex-wrap gap-3 text-sm text-foreground font-medium">
                ...
                <span className="px-3 py-1.5 rounded-full bg-accent/10 text-accent">
                  No chasing
                </span>
