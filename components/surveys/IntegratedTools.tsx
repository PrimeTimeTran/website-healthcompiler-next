          ...
          <div className='grid lg:grid-cols-2 gap-12 items-center'>
            ...
            <div className='space-y-6 order-1 lg:order-2'>
              ...
              <p className='text-muted-foreground'>
                Health Compiler integrates survey responses directly into your
                analytics, CRM, communication, and operational systems—so teams
                can follow up, respond, and improve in real time.
              </p>
