          ...
          <div className='grid lg:grid-cols-2 gap-12 items-center'>
            ...
            <div className='space-y-6'>
              ...
              <p className='text-lg text-muted-foreground'>
                Health Compiler automates feedback collection based on what
                actually happens—visits, milestones, resolutions—not generic
                schedules.
              </p>

              <p className='text-muted-foreground'>
                Surveys are sent when engagement is highest, and responses flow
                directly into your systems, not into a forgotten inbox.
              </p>
