...
const features = [
  {
    ...
    title: 'NPS Surveys',
    description:
      'Measure loyalty over time, spot trends early, and understand what is driving satisfaction across your population.',
    color: '#f97316',
  },
  {
    icon: ThumbsUp,
    title: 'CSAT Surveys',
    description:
      'Capture satisfaction immediately after interactions to improve service quality while context is still fresh.',
    color: '#06b6d4',
  },
  {
    icon: MessageSquare,
    ...
    description:
      'Automatically request reviews from satisfied users and strengthen your online presence without manual follow-up.',
    color: '#8b5cf6',
  },
  {
    icon: Smartphone,
    ...
    description:
      'Send surveys via SMS, email, or embedded workflows—based on how your users actually engage.',
    color: '#22c55e',
  },
]
      ...
      <div className='container mx-auto px-4'>
        <div className='text-center mb-16'>
          <h2 className='text-3xl md:text-4xl font-bold mb-4'>
            Feedback That Fits Into Everyday Work
          </h2>
          <p className='text-lg text-muted-foreground max-w-2xl mx-auto'>
            Collect the right feedback at the right moment, through the channels
            your users prefer.
          </p>
        </div>
